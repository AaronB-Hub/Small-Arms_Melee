...
__attribute__((used)) static struct FtState move_logic[] = {
	...
	// State: 370 - AppealSStartR
	{
		321,        // AnimationID
		0x72,       // StateFlags
		0x1,        // AttackID
		0x0,        // BitFlags
		0x800E5B18, // AnimationCallback
		0x800E5C38, // IASACallback
		0x800E5C3C, // PhysicsCallback
		0x800E5C5C, // CollisionCallback
		0x800761C8, // CameraCallback
	},
	// State: 371 - AppealSStartL
	{
		322,        // AnimationID
		0x72,       // StateFlags
		0x1,        // AttackID
