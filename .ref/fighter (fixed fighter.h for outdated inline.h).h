...
struct FighterData
{
    ...
    {                              //
		...
		//  Inserted attributes back into struct to fix compile error
		...
		// Moved this part of the struct to accomodate added back in attributes
        FtDmgLog hit_log;          // 0x1920, info regarding the last solid hit

		// Commented these out to make room for the moved struct
        // int x1924;                 // 0x1924
        // int x1928;                 // 0x1928
        // int x192c;                 // 0x192c
        // int x1930;                 // 0x1930
