...
::"MexTK.exe" -ff -i "%MrPATH%\mario.c" "%MrPATH%\special_n.c" "%MrPATH%\special_s.c" "%MrPATH%\special_lw.c" "%MrPATH%\special_hi.c" -s ftFunction -dat "%FilesPATH%\PlMr.dat" -ow
...
:: ----- Test Character -----
:: compile main code
::"MexTK.exe" -ff -i "%TsPATH%\test.c" "%TsPATH%\special_n.c" "%TsPATH%\special_s.c" "%TsPATH%\special_lw.c" "%TsPATH%\special_hi.c" -s ftFunction -dat "%FilesPATH%\PlTs.dat" -ow 

:: compile item code
::"MexTK.exe" -ff -item 0 "%TsPATH%\item_fireball.c" -item 2 "%TsPATH%\item_cape.c" -dat "%FilesPATH%\PlTs.dat" -s itFunction -ow
