...
"MexTK.exe" -ff -i "%TsPATH%\test.c" "%TsPATH%\SA_special_move_logic.c" "%TsPATH%\float.c" "%TsPATH%\leap.c" "%TsPATH%\kicks.c" "%TsPATH%\SA_item.c" "%TsPATH%\itemFire.c" -s ftFunction -t "%TKPATH%\ftFunction.txt" -l "%TKPATH%\melee.link" -dat "%FilesPATH%\PlTs.dat" -ow
